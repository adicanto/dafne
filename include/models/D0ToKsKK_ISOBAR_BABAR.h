...
auto Amplitude(ThreeBodyPhaseSpace const &phsp)
{
	...
	auto PHI_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::PWave,2,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,phsp,"phi","#it{#phi}(1020)");
	...
	auto A00_980_amp = FlatteAmplitude<MSq12,MSq13,hydra::SWave,2,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,g1_a0_980,g2_a0_980,mEta,mPi,phsp,"a00_980","#it{a}_{0}(980)^{0}");
	...
	auto A0p_980_amp = FlatteAmplitude<MSq12,MSq13,hydra::SWave,1,2,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,g1_a0_980,g2_a0_980,mEta,mPi,phsp,"a0p_980","#it{a}_{0}(980)^{+}");
	...
	auto A0m_980_amp = FlatteAmplitude<MSq12,MSq13,hydra::SWave,1,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,g1_a0_980,g2_a0_980,mEta,mPi,phsp,"a0m_980","#it{a}_{0}(980)^{#minus}");
	...
	auto A00_1450_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::SWave,2,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,phsp,"a00_1450","#it{a}_{0}(1450)^{0}");
	...
	auto A0p_1450_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::SWave,1,2,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,phsp,"a0p_1450","#it{a}_{0}(1450)^{+}");
	...
	auto A0m_1450_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::SWave,1,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,radius,radius,phsp,"a0m_1450","#it{a}_{0}(1450)^{#minus}");
	...
	auto F0_1370_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::SWave,2,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,phsp,"f0_1370","#if{f}_{0}(1370)");
	...
	auto F2_1270_amp = BreitWignerAmplitude<MSq12,MSq13,hydra::DWave,2,3,BaBarKSpipi,Helicity>(c_re,c_im,mass,width,phsp,"f2_1270","#if{f}_{2}(1370)");
